...
const Hero = () => {
  ...
  return (
    ...
    >
     <h1 className="font-display col-span-12 mt-26 h-fit text-6xl text-black lg:col-start-1 lg:col-end-7 lg:mt-0 lg:text-[9rem] lg:leading-[calc(9.6875rem*1.2)] 2xl:text-[13.5rem] 2xl:leading-[calc(13.5rem*1.2)]">
        <span className="heading inline-block translate-y-full">Creation</span>
      </h1>
      <h1 className="font-display col-span-12 h-fit overflow-hidden text-6xl text-black lg:col-start-3 lg:col-end-12 lg:text-[9rem] lg:leading-[calc(9.6875rem*1.2)] 2xl:text-[13.5rem] 2xl:leading-[calc(13.5rem*1.2)]">
        <span className="heading inline-block translate-y-full">without</span>
      </h1>
      ...
      <div className="col-span-12 mx-auto mt-6 flex w-full max-w-[320px] flex-col items-center justify-center lg:col-start-9 lg:col-end-13 lg:mt-0 2xl:max-w-[450px]">
        ...
        We craft intelligent, <br></br>
        high-impact digital architecture and market <br></br> strategy for company in need <br></br>
        <strong>with zero limits.</strong>
        </h2>
      </div>
